...
final class GetAllVipRx extends RxResponseInt<GetAllVipModelData> {
  final api = GetAllVipApi.instance;

  GetAllVipRx({required super.empty, required super.dataFetcher});
  ...
  Future<GetAllVipModelData?> getAllPeopleData( ) async {
    try {
      clearData();
      final  data = await api.getVipPeopleInfo();
