...
class vipProfileAddToSparkCard extends StatelessWidget {
  const vipProfileAddToSparkCard({
    ...
    required this.sparkNumber,
    required this.onAddSparkTap,
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child:
                          Text(type, style: TextFontStyle.textStyle10InterW400),
                    )
                  ],
                )
              ],
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text('spark', style: TextFontStyle.textStyle12InterW600),
                    ],
                  ),
                )
              ],
