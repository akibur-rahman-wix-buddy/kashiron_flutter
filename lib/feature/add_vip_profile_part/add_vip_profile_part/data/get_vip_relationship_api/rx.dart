...
final class GetVipRelationshipRx extends RxResponseInt<RelationDataModel> {
  final api = GetVipRelationshipAPi.instance;

  GetVipRelationshipRx({required super.empty, required super.dataFetcher});
  ...
  Future<RelationDataModel?> getPeopleData( ) async {
    try {
      clearData();
