...
class SetPassSuccess extends StatelessWidget {
    ...
    return Dialog(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Image.asset(AppImages.successFirework, width: double.infinity, height: 170.h,),
            ...
            Text(
              "Step one's done, now lets set up your crew! Add in your VIP's and never miss a big day again",
            ...
            CustomElevatedButton(text: "Let's do it", onPressed: onCreateAccount),
            const SizedBox(height: 16),
